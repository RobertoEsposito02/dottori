...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler{
	...
	@ExceptionHandler(DottoreNonDisponibileEsception.class)
	public ResponseEntity<Object> handleDottoreNonDisponibileEsception(DottoreNonDisponibileEsception ex,
			WebRequest request) {
